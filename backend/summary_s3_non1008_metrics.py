"""
Summary Step S3: Extract Metrics for Non-1008 Loans

For loans without 1008 documents or missing key metrics, extract from alternative sources:
...
This step runs after S1 (Profile Extraction) and S2 (DSCR) to fill in missing metrics.
"""
