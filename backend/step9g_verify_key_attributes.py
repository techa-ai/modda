"""
Step 9g: Verify Key Loan Attributes

Verifies the four key loan attributes that drive underwriting decisions:
...
Each verification checks if the value in the loan profile matches evidence in documents.
"""
...
def save_verification_status(loan_id, verification_data):
    ...
    try:
        ...
        profile['verification_status'] = verification_data
